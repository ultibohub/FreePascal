...
Const
  ...
  NoApacheOSes        = [amiga,aros,morphos,wasip1,wasip1threads,ultibo];
  NoCGIOSes           = [amiga,aros,morphos,wasip1,wasip1threads,ultibo];
...
begin
  With Installer do
    ...
    P.Version:='3.3.1';
    P.OSes := [beos,haiku,freebsd,darwin,iphonesim,ios,solaris,netbsd,openbsd,linux,win32,win64,wince,aix,amiga,aros,morphos,dragonfly,android,wasip1,wasip1threads,ultibo];
