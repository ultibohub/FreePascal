...
{$else}
      ...
      TOS=(
        ...
        zxspectrum,msxdos,ios,amstradcpc,sinclairql,wasi,human68k,ultibo
      );
{$endif}
    ...
    const
      ...
      OSStr : array[TOS] of string=(
        ...
        'ios','amstradcpc','sinclairql','wasi','human68k', 'ultibo'
      );
      ...
      OSSuffix : array[TOS] of string=(
        ...
        '_ios','_amstradcpc','_sinclairql','_wasi','_human68k', '_ultibo'
      );
